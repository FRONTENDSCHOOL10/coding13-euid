    ...
    <ul class="flex justify-between">
      <li>
        <a href="/" class="flex flex-col items-center text-sm">
          <img id="nav-img-home" src=${home} alt="홈" aria-hidden="true" class="aspect-square w-5 xs:w-7 sm:w-9" />
          <span class="text-sm-group leading-[160%]">홈</span>
        </a>
      </li>
      <li>
        <a href="/pages/board/" class="flex flex-col items-center text-sm">
          <img id="nav-img-board" src=${board} alt="게시판" aria-hidden="true" class="aspect-square w-5 xs:w-7 sm:w-9" />
          <span class="text-sm-group leading-[160%]">게시판</span>
        </a>
      </li>
      <li>
        <a href="/pages/exchange/" class="flex flex-col items-center text-sm">
          <img id="nav-img-map" src=${map} alt="내 근처" aria-hidden="true" class="aspect-square w-5 xs:w-7 sm:w-9" />
          <span class="text-sm-group leading-[160%]">내 근처</span>
        </a>
      </li>
      <li>
        <a href="/pages/chat/" class="flex flex-col items-center text-sm">
          <img id="nav-img-chat" src=${chat} alt="채팅" aria-hidden="true" class="aspect-square w-5 xs:w-7 sm:w-9" />
          <span class="text-sm-group leading-[160%]">채팅</span>
        </a>
      </li>
      <li>
        <a href="/pages/profile/" class="flex flex-col items-center text-sm">
          <img id="nav-img-my" src=${my} alt="나의 이듬" aria-hidden="true" class="aspect-square w-5 xs:w-7 sm:w-9" />
